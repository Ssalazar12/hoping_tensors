...
data_route = "/scratch/scc/santiago.salazar-jaramillo/hoping_tensors/data/sims/L=23/"
# it is important to have them as lists

L_qpc_list = [23]  # lenth of the QPC chain
L_list = [L_qpc_list[0]+2] # QPC times double dot 
max_t_list = [11] # maximum time
tsteps_list = [350] # number of time steps
bond_index_list = 8  # int(L_qpc_list[0]/2) # dangling bond between bond_index and bond_index+1
...
Omega_list = [0.3] #[0.0, 0.1, 0.3 ,0.5, 0.7]  # coupling between dot 1 and QPC
